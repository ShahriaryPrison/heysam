...
function TeamMember() {
  return (
    <section id="team-member" className="w-full flex flex-col gap-36 py-10 px-8 lg:px-16">
      <h4 className="text-white w-full text-center text-3xl">Team Members</h4>
      <div className="relative w-full flex flex-wrap items-center justify-center gap-8">
