...
function Skills() {
  ...
  return (
    <section className="w-full flex flex-col gap-36 py-10">
      <h4 className="text-white w-full text-center text-3xl">Skills</h4>
      <div className="w-full max-w-7xl grid grid-cols-6 justify-center items-center mx-auto grid-rows-3 gap-8">
